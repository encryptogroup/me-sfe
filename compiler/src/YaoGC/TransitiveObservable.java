...
public class TransitiveObservable {
	...
	List<TransitiveObserver> observers = new ArrayList<TransitiveObserver>(3);
	 ...
	 *            the Observer to add.
	 */
	public void addObserver(TransitiveObserver observer) {
		if (observer == null) {
	...
	/**
	 * Sets the changed flag for this {@code Observable}. After calling {@code
	 * setChanged()}, {@code hasChanged()} will return {@code true}.
	 */
